...
mkdir build
cd build
cmake -DLIB_ONLY=OFF -DICU_ROOT=$ROOT_DIR/icu/ -DCMAKE_INSTALL_PREFIX=$ROOT_DIR/outputs/Release/ -DCMAKE_BUILD_TYPE=Release ..
cmake --build . --config Release --target install

cmake -DLIB_ONLY=OFF -DICU_ROOT=$ROOT_DIR/icu/ -DCMAKE_INSTALL_PREFIX=$ROOT_DIR/outputs/Debug/ -DCMAKE_BUILD_TYPE=Debug ..
